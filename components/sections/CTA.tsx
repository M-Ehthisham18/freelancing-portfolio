          ...
          <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-7 md:gap-12">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
              <Link
                href="/contact"
                data-magnetic="Book"
                className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-primary text-on-primary rounded-lg font-bold text-body-md font-headline-md hover:opacity-90 transition-all active:scale-95 shadow-lg shadow-primary/20 text-center min-h-[52px] flex items-center justify-center"
              >
              ...
              <a
                href="#projects"
                data-magnetic="View"
                className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-transparent border border-outline text-on-background rounded-lg font-medium text-body-md font-headline-md hover:bg-surface-container transition-all active:scale-95 text-center min-h-[52px] flex items-center justify-center"
              >
                View My Projects
              </a>
            </div>

            <div className="flex flex-wrap justify-center items-center gap-x-6 sm:gap-x-8 gap-y-3 pt-6 sm:pt-8 border-t border-outline-variant/10 w-full max-w-2xl">
